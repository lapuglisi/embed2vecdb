...
#ifndef json_5fwith_5fint_2eproto_2epb_2eh
#define json_5fwith_5fint_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_json_5fwith_5fint_2eproto
...
struct TableStruct_json_5fwith_5fint_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_json_5fwith_5fint_2eproto;
}  // extern "C"
namespace qdrant {
enum NullValue : int;
...
namespace protobuf {
template <>
internal::EnumTraitsT<::qdrant::NullValue_internal_data_>
    internal::EnumTraitsImpl::value<::qdrant::NullValue>;
}  // namespace protobuf
}  // namespace google
...
/* @@protoc_insertion_point(class_definition:qdrant.ListValue) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "qdrant.ListValue"; }
 ...
 public:
  ...
  public:
  void clear_values() ;
  ::qdrant::Value* PROTOBUF_NONNULL mutable_values(int index);
  ::google::protobuf::RepeatedPtrField<::qdrant::Value>* PROTOBUF_NONNULL mutable_values();

  private:
  const ::google::protobuf::RepeatedPtrField<::qdrant::Value>& _internal_values() const;
  ::google::protobuf::RepeatedPtrField<::qdrant::Value>* PROTOBUF_NONNULL _internal_mutable_values();
  public:
  const ::qdrant::Value& values(int index) const;
  ::qdrant::Value* PROTOBUF_NONNULL add_values();
  const ::google::protobuf::RepeatedPtrField<::qdrant::Value>& values() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::qdrant::Value > values_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_json_5fwith_5fint_2eproto;
};
...
/* @@protoc_insertion_point(class_definition:qdrant.Struct) */ {
 public:
 ...
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "qdrant.Struct"; }
 ...
 public:
  ...
  public:
  void clear_fields() ;
  const ::google::protobuf::Map<::std::string, ::qdrant::Value>& fields() const;
  ::google::protobuf::Map<::std::string, ::qdrant::Value>* PROTOBUF_NONNULL mutable_fields();

  private:
  const ::google::protobuf::Map<::std::string, ::qdrant::Value>& _internal_fields() const;
  ::google::protobuf::Map<::std::string, ::qdrant::Value>* PROTOBUF_NONNULL _internal_mutable_fields();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::internal::MapField<Struct_FieldsEntry_DoNotUse, ::std::string, ::qdrant::Value,
...
/* @@protoc_insertion_point(class_definition:qdrant.Value) */ {
 public:
 ...
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "qdrant.Value"; }
 ...
 public:
  ...
  enum : int {
    ...
    kStructValueFieldNumber = 6,
    kListValueFieldNumber = 7,
  };
  // .qdrant.NullValue null_value = 1;
  bool has_null_value() const;
  void clear_null_value() ;
  ::qdrant::NullValue null_value() const;
  void set_null_value(::qdrant::NullValue value);

  private:
  ::qdrant::NullValue _internal_null_value() const;
  void _internal_set_null_value(::qdrant::NullValue value);
  ...
  const ::qdrant::Struct& struct_value() const;
  [[nodiscard]] ::qdrant::Struct* PROTOBUF_NULLABLE release_struct_value();
  ::qdrant::Struct* PROTOBUF_NONNULL mutable_struct_value();
  void set_allocated_struct_value(::qdrant::Struct* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_struct_value(::qdrant::Struct* PROTOBUF_NULLABLE value);
  ::qdrant::Struct* PROTOBUF_NULLABLE unsafe_arena_release_struct_value();

  private:
  const ::qdrant::Struct& _internal_struct_value() const;
  ::qdrant::Struct* PROTOBUF_NONNULL _internal_mutable_struct_value();
  ...
  const ::qdrant::ListValue& list_value() const;
  [[nodiscard]] ::qdrant::ListValue* PROTOBUF_NULLABLE release_list_value();
  ::qdrant::ListValue* PROTOBUF_NONNULL mutable_list_value();
  void set_allocated_list_value(::qdrant::ListValue* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_list_value(::qdrant::ListValue* PROTOBUF_NULLABLE value);
  ::qdrant::ListValue* PROTOBUF_NULLABLE unsafe_arena_release_list_value();

  private:
  const ::qdrant::ListValue& _internal_list_value() const;
  ::qdrant::ListValue* PROTOBUF_NONNULL _internal_mutable_list_value();
 ...
 private:
  ...
  struct Impl_ {
    ...
    union KindUnion {
      ...
      bool bool_value_;
      ::qdrant::Struct* PROTOBUF_NULLABLE struct_value_;
      ::qdrant::ListValue* PROTOBUF_NULLABLE list_value_;
    } kind_;
    ::google::protobuf::internal::CachedSize _cached_size_;
...
inline const ::google::protobuf::Map<::std::string, ::qdrant::Value>& Struct::_internal_fields() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.fields_.GetMap();
}
inline const ::google::protobuf::Map<::std::string, ::qdrant::Value>& Struct::fields() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_map:qdrant.Struct.fields)
  return _internal_fields();
}
inline ::google::protobuf::Map<::std::string, ::qdrant::Value>* PROTOBUF_NONNULL Struct::_internal_mutable_fields() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.fields_.MutableMap();
}
inline ::google::protobuf::Map<::std::string, ::qdrant::Value>* PROTOBUF_NONNULL Struct::mutable_fields()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_mutable_map:qdrant.Struct.fields)
...
inline ::qdrant::NullValue Value::null_value() const {
  // @@protoc_insertion_point(field_get:qdrant.Value.null_value)
  return _internal_null_value();
}
inline void Value::set_null_value(::qdrant::NullValue value) {
  if (kind_case() != kNullValue) {
    clear_kind();
    set_has_null_value();
  }
  _impl_.kind_.null_value_ = value;
  // @@protoc_insertion_point(field_set:qdrant.Value.null_value)
}
inline ::qdrant::NullValue Value::_internal_null_value() const {
  if (kind_case() == kNullValue) {
    return static_cast<::qdrant::NullValue>(_impl_.kind_.null_value_);
  }
  return static_cast<::qdrant::NullValue>(0);
}
...
inline double Value::double_value() const {
  // @@protoc_insertion_point(field_get:qdrant.Value.double_value)
...
inline void Value::set_double_value(double value) {
  ...
  // @@protoc_insertion_point(field_set:qdrant.Value.double_value)
}
...
inline ::int64_t Value::integer_value() const {
  // @@protoc_insertion_point(field_get:qdrant.Value.integer_value)
...
inline void Value::set_integer_value(::int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:qdrant.Value.integer_value)
}
...
inline const ::std::string& Value::string_value() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:qdrant.Value.string_value)
...
PROTOBUF_ALWAYS_INLINE void Value::set_string_value(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:qdrant.Value.string_value)
}
inline ::std::string* PROTOBUF_NONNULL Value::mutable_string_value()
  ...
  // @@protoc_insertion_point(field_mutable:qdrant.Value.string_value)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Value::release_string_value() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:qdrant.Value.string_value)
  if (kind_case() != kStringValue) {
    return nullptr;
  }
  clear_has_kind();
...
inline void Value::set_allocated_string_value(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:qdrant.Value.string_value)
}
...
inline bool Value::bool_value() const {
  // @@protoc_insertion_point(field_get:qdrant.Value.bool_value)
...
inline void Value::set_bool_value(bool value) {
  ...
  // @@protoc_insertion_point(field_set:qdrant.Value.bool_value)
}
...
inline ::qdrant::Struct* PROTOBUF_NULLABLE Value::release_struct_value() {
  // @@protoc_insertion_point(field_release:qdrant.Value.struct_value)
  if (kind_case() == kStructValue) {
    clear_has_kind();
...
inline const ::qdrant::Struct& Value::_internal_struct_value() const {
  return kind_case() == kStructValue ? static_cast<const ::qdrant::Struct&>(*_impl_.kind_.struct_value_)
                     : reinterpret_cast<const ::qdrant::Struct&>(::qdrant::_Struct_default_instance_);
}
inline const ::qdrant::Struct& Value::struct_value() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:qdrant.Value.struct_value)
  return _internal_struct_value();
}
inline ::qdrant::Struct* PROTOBUF_NULLABLE Value::unsafe_arena_release_struct_value() {
  // @@protoc_insertion_point(field_unsafe_arena_release:qdrant.Value.struct_value)
  if (kind_case() == kStructValue) {
    clear_has_kind();
    auto* temp = _impl_.kind_.struct_value_;
    _impl_.kind_.struct_value_ = nullptr;
...
inline void Value::unsafe_arena_set_allocated_struct_value(
    ::qdrant::Struct* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:qdrant.Value.struct_value)
}
inline ::qdrant::Struct* PROTOBUF_NONNULL Value::_internal_mutable_struct_value() {
  if (kind_case() != kStructValue) {
    clear_kind();
    set_has_struct_value();
    _impl_.kind_.struct_value_ = 
        ::google::protobuf::Message::DefaultConstruct<::qdrant::Struct>(GetArena());
  }
  return _impl_.kind_.struct_value_;
}
inline ::qdrant::Struct* PROTOBUF_NONNULL Value::mutable_struct_value()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::qdrant::Struct* _msg = _internal_mutable_struct_value();
  // @@protoc_insertion_point(field_mutable:qdrant.Value.struct_value)
  return _msg;
}
...
inline ::qdrant::ListValue* PROTOBUF_NULLABLE Value::release_list_value() {
  // @@protoc_insertion_point(field_release:qdrant.Value.list_value)
  if (kind_case() == kListValue) {
    clear_has_kind();
...
inline const ::qdrant::ListValue& Value::_internal_list_value() const {
  return kind_case() == kListValue ? static_cast<const ::qdrant::ListValue&>(*_impl_.kind_.list_value_)
                     : reinterpret_cast<const ::qdrant::ListValue&>(::qdrant::_ListValue_default_instance_);
}
inline const ::qdrant::ListValue& Value::list_value() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:qdrant.Value.list_value)
  return _internal_list_value();
}
inline ::qdrant::ListValue* PROTOBUF_NULLABLE Value::unsafe_arena_release_list_value() {
  // @@protoc_insertion_point(field_unsafe_arena_release:qdrant.Value.list_value)
  if (kind_case() == kListValue) {
    clear_has_kind();
    auto* temp = _impl_.kind_.list_value_;
    _impl_.kind_.list_value_ = nullptr;
...
inline void Value::unsafe_arena_set_allocated_list_value(
    ::qdrant::ListValue* PROTOBUF_NULLABLE value) {
  // We rely on the oneof clear method to free the earlier contents
  // of this oneof. We can directly use the pointer we're given to
  // set the new value.
  clear_kind();
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:qdrant.Value.list_value)
}
inline ::qdrant::ListValue* PROTOBUF_NONNULL Value::_internal_mutable_list_value() {
  if (kind_case() != kListValue) {
    clear_kind();
    set_has_list_value();
    _impl_.kind_.list_value_ = 
        ::google::protobuf::Message::DefaultConstruct<::qdrant::ListValue>(GetArena());
  }
  return _impl_.kind_.list_value_;
}
inline ::qdrant::ListValue* PROTOBUF_NONNULL Value::mutable_list_value()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::qdrant::ListValue* _msg = _internal_mutable_list_value();
  // @@protoc_insertion_point(field_mutable:qdrant.Value.list_value)
  return _msg;
}
...
inline ::qdrant::Value* PROTOBUF_NONNULL ListValue::mutable_values(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:qdrant.ListValue.values)
  return _internal_mutable_values()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::qdrant::Value>* PROTOBUF_NONNULL ListValue::mutable_values()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_mutable_list:qdrant.ListValue.values)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_values();
}
inline const ::qdrant::Value& ListValue::values(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:qdrant.ListValue.values)
  return _internal_values().Get(index);
}
inline ::qdrant::Value* PROTOBUF_NONNULL ListValue::add_values()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::qdrant::Value* _add =
  ...
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_add:qdrant.ListValue.values)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::qdrant::Value>& ListValue::values() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:qdrant.ListValue.values)
  return _internal_values();
}
inline const ::google::protobuf::RepeatedPtrField<::qdrant::Value>&
ListValue::_internal_values() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.values_;
}
inline ::google::protobuf::RepeatedPtrField<::qdrant::Value>* PROTOBUF_NONNULL
...
template <>
struct is_proto_enum<::qdrant::NullValue> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::qdrant::NullValue>() {
  return ::qdrant::NullValue_descriptor();
}
...
#endif  // json_5fwith_5fint_2eproto_2epb_2eh
