...
static const ::_pb::EnumDescriptor* PROTOBUF_NONNULL
    file_level_enum_descriptors_json_5fwith_5fint_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_json_5fwith_5fint_2eproto = nullptr;
const ::uint32_t
    TableStruct_json_5fwith_5fint_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::qdrant::Struct_FieldsEntry_DoNotUse, _impl_._has_bits_),
        5, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::qdrant::Struct_FieldsEntry_DoNotUse, _impl_.key_),
        PROTOBUF_FIELD_OFFSET(::qdrant::Struct_FieldsEntry_DoNotUse, _impl_.value_),
        0,
        1,
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::qdrant::Struct, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::qdrant::Struct, _impl_.fields_),
        0,
        0x004, // bitmap
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_._oneof_case_[0]),
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        ...
        PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_.kind_),
        0x081, // bitmap
        PROTOBUF_FIELD_OFFSET(::qdrant::ListValue, _impl_._has_bits_),
        4, // hasbit index offset
        PROTOBUF_FIELD_OFFSET(::qdrant::ListValue, _impl_.values_),
        0,
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::qdrant::Struct_FieldsEntry_DoNotUse)},
        {7, sizeof(::qdrant::Struct)},
        {12, sizeof(::qdrant::Value)},
        {22, sizeof(::qdrant::ListValue)},
};
static const ::_pb::Message* PROTOBUF_NONNULL const file_default_instances[] = {
    &::qdrant::_Struct_FieldsEntry_DoNotUse_default_instance_._instance,
    &::qdrant::_Struct_default_instance_._instance,
    &::qdrant::_Value_default_instance_._instance,
    &::qdrant::_ListValue_default_instance_._instance,
};
const char descriptor_table_protodef_json_5fwith_5fint_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    ...
    "\nNULL_VALUE\020\000B\025\252\002\022Qdrant.Client.Grpcb\006pr"
    "oto3"
};
static ::absl::once_flag descriptor_table_json_5fwith_5fint_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_json_5fwith_5fint_2eproto = {
    false,
    false,
    484,
    descriptor_table_protodef_json_5fwith_5fint_2eproto,
    "json_with_int.proto",
    &descriptor_table_json_5fwith_5fint_2eproto_once,
    nullptr,
    0,
    4,
    schemas,
    file_default_instances,
    TableStruct_json_5fwith_5fint_2eproto::offsets,
    file_level_enum_descriptors_json_5fwith_5fint_2eproto,
    file_level_service_descriptors_json_5fwith_5fint_2eproto,
};
namespace qdrant {
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL NullValue_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_json_5fwith_5fint_2eproto);
  return file_level_enum_descriptors_json_5fwith_5fint_2eproto[0];
}
...
constexpr auto Struct_FieldsEntry_DoNotUse::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_json_5fwith_5fint_2eproto,
      nullptr,  // tracker
  };
}
...
Struct_FieldsEntry_DoNotUse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::qdrant::Struct_FieldsEntry_DoNotUse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // .qdrant.Value value = 2;
  ...
  {{
      {::_pbi::TcParser::GetTable<::qdrant::Value>()},
  }},
  {{
    "\31\3\0\0\0\0\0\0"
    "qdrant.Struct.FieldsEntry"
    "key"
  }},
};
// ===================================================================
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:qdrant.Struct)
}
PROTOBUF_NDEBUG_INLINE Struct::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::qdrant::Struct& from_msg)
...
Struct::Struct(
  ...
  // @@protoc_insertion_point(copy_constructor:qdrant.Struct)
}
PROTOBUF_NDEBUG_INLINE Struct::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
...
Struct::~Struct() {
  // @@protoc_insertion_point(destructor:qdrant.Struct)
  SharedDtor(*this);
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 2, 28, 2>
Struct::_table_ = {
  {
    ...
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::qdrant::Struct>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:qdrant.Struct)
...
::uint8_t* PROTOBUF_NONNULL Struct::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:qdrant.Struct)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
    if (!this_._internal_fields().empty()) {
      using MapType = ::google::protobuf::Map<::std::string, ::qdrant::Value>;
      using WireHelper = _pbi::MapEntryFuncs<::std::string, ::qdrant::Value,
 ...
 ::google::protobuf::internal::WireFormatLite::SERIALIZE, "qdrant.Struct.fields");
        }
      } else {
 ...
 ::google::protobuf::internal::WireFormatLite::SERIALIZE, "qdrant.Struct.fields");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:qdrant.Struct)
  return target;
}
...
::size_t Struct::ByteSizeLong() const {
  const Struct& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:qdrant.Struct)
  ::size_t total_size = 0;
  ...
  ::_pbi::Prefetch5LinesFrom7Lines(&this_);
   {
    ...
    if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
      ...
      for (const auto& entry : this_._internal_fields()) {
        total_size += _pbi::MapEntryFuncs<::std::string, ::qdrant::Value,
                                       _pbi::WireFormatLite::TYPE_STRING,
...
void Struct::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:qdrant.Struct)
...
void Struct::CopyFrom(const Struct& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:qdrant.Struct)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Value::_Internal {
 public:
  static constexpr ::int32_t kOneofCaseOffset =
      PROTOBUF_FIELD_OFFSET(::qdrant::Value, _impl_._oneof_case_);
};

void Value::set_allocated_struct_value(::qdrant::Struct* PROTOBUF_NULLABLE struct_value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:qdrant.Value.struct_value)
}
void Value::set_allocated_list_value(::qdrant::ListValue* PROTOBUF_NULLABLE list_value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  clear_kind();
  if (list_value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:qdrant.Value.list_value)
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:qdrant.Value)
}
PROTOBUF_NDEBUG_INLINE Value::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::qdrant::Value& from_msg)
      : kind_{},
        _cached_size_{0},
...
Value::Value(
  ...
  switch (kind_case()) {
    case KIND_NOT_SET:
      ...
      case kDoubleValue:
        ...
        break;
      case kIntegerValue:
        _impl_.kind_.integer_value_ = from._impl_.kind_.integer_value_;
        break;
      case kStringValue:
  ...
  // @@protoc_insertion_point(copy_constructor:qdrant.Value)
}
PROTOBUF_NDEBUG_INLINE Value::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
Value::~Value() {
  // @@protoc_insertion_point(destructor:qdrant.Value)
  SharedDtor(*this);
}
...
// @@protoc_insertion_point(one_of_clear_start:qdrant.Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  switch (kind_case()) {
    case kNullValue: {
      // No need to clear
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 7, 2, 33, 2>
Value::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::qdrant::Value>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    ...
    {PROTOBUF_FIELD_OFFSET(Value, _impl_.kind_.integer_value_), _Internal::kOneofCaseOffset + 0, 0, (0 | ::_fl::kFcOneof | ::_fl::kInt64)},
  ...
  {{
      {::_pbi::TcParser::GetTable<::qdrant::Struct>()},
      {::_pbi::TcParser::GetTable<::qdrant::ListValue>()},
  }},
  {{
    "\14\0\0\0\14\0\0\0"
    "qdrant.Value"
...
// @@protoc_insertion_point(message_clear_start:qdrant.Value)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL Value::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:qdrant.Value)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  switch (this_.kind_case()) {
    ...
    case kStringValue: {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "qdrant.Value.string_value");
    ...
    case kStructValue: {
      target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
          6, *this_._impl_.kind_.struct_value_, this_._impl_.kind_.struct_value_->GetCachedSize(), target,
          stream);
      break;
    }
    case kListValue: {
      target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
          7, *this_._impl_.kind_.list_value_, this_._impl_.kind_.list_value_->GetCachedSize(), target,
          stream);
      break;
    }
    default:
  ...
  // @@protoc_insertion_point(serialize_to_array_end:qdrant.Value)
  return target;
}
...
::size_t Value::ByteSizeLong() const {
  const Value& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:qdrant.Value)
  ::size_t total_size = 0;
...
void Value::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:qdrant.Value)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (const uint32_t oneof_from_case =
    ...
    switch (oneof_from_case) {
      ...
      case kIntegerValue: {
        _this->_impl_.kind_.integer_value_ = from._impl_.kind_.integer_value_;
        break;
      }
      case kStringValue: {
        if (oneof_needs_init) {
...
void Value::CopyFrom(const Value& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:qdrant.Value)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:qdrant.ListValue)
}
PROTOBUF_NDEBUG_INLINE ListValue::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::qdrant::ListValue& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
...
ListValue::ListValue(
  ...
  // @@protoc_insertion_point(copy_constructor:qdrant.ListValue)
}
PROTOBUF_NDEBUG_INLINE ListValue::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
...
ListValue::~ListValue() {
  // @@protoc_insertion_point(destructor:qdrant.ListValue)
  SharedDtor(*this);
}
...
ListValue::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::qdrant::ListValue>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
// @@protoc_insertion_point(message_clear_start:qdrant.ListValue)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::uint8_t* PROTOBUF_NONNULL ListValue::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:qdrant.ListValue)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:qdrant.ListValue)
  return target;
}
...
::size_t ListValue::ByteSizeLong() const {
  const ListValue& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
  // @@protoc_insertion_point(message_byte_size_start:qdrant.ListValue)
  ::size_t total_size = 0;
...
void ListValue::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  ::google::protobuf::Arena* arena = _this->GetArena();
  // @@protoc_insertion_point(class_specific_merge_from_start:qdrant.ListValue)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
...
void ListValue::CopyFrom(const ListValue& from) {
  // @@protoc_insertion_point(class_specific_copy_from_start:qdrant.ListValue)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_json_5fwith_5fint_2eproto),
         ::std::false_type{});
