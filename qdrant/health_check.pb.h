...
#ifndef health_5fcheck_2eproto_2epb_2eh
#define health_5fcheck_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_health_5fcheck_2eproto;
}  // extern "C"
namespace grpc {
namespace health {
namespace v1 {
...
inline constexpr HealthCheckResponse_ServingStatus HealthCheckResponse_ServingStatus_ServingStatus_MAX =
    static_cast<HealthCheckResponse_ServingStatus>(3);
inline bool HealthCheckResponse_ServingStatus_IsValid(int value) {
  return 0 <= value && value <= 3;
}
inline constexpr int HealthCheckResponse_ServingStatus_ServingStatus_ARRAYSIZE = 3 + 1;
...
inline const ::std::string& HealthCheckResponse_ServingStatus_Name(HealthCheckResponse_ServingStatus value) {
  return ::google::protobuf::internal::NameOfDenseEnum<HealthCheckResponse_ServingStatus_descriptor, 0, 3>(
...
#endif  // health_5fcheck_2eproto_2epb_2eh
